...
-- Save undo history and undo steps are available after leaving neovim
...
-- show a vertical line for max lenght line
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.ai').setup {
        dependencies = 'nvim-treesitter/nvim-treesitter-textobjets',
        n_lines = 500,
      }
